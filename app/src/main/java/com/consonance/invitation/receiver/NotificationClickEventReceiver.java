package com.consonance.invitation.receiver;
    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(InApplication.TARGET_ID, targetId);
                notificationIntent.putExtra(InApplication.TARGET_APP_KEY, appKey);
                Log.d("Notification", "msg.fromAppKey() " + appKey);
            } else {
                conv = JMessageClient.getGroupConversation(Long.parseLong(targetId));
                notificationIntent.putExtra(InApplication.GROUP_ID, Long.parseLong(targetId));
            }
