...
import com.consonance.invitation.adapter.AlbumListAdapter;
import com.consonance.invitation.data.InApplication;
import com.consonance.invitation.entity.ImageBean;
import com.consonance.invitation.tools.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, InApplication.REQUEST_CODE_SELECT_ALBUM);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == InApplication.RESULT_CODE_SELECT_ALBUM) {
			setResult(InApplication.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
