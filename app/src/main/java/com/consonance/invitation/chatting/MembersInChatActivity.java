...
import com.consonance.invitation.adapter.AllMembersAdapter;
import com.consonance.invitation.data.InApplication;
import com.consonance.invitation.tools.HanyuPinyin;
...
public class MembersInChatActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsDeleteMode = getIntent().getBooleanExtra(InApplication.DELETE_MODE, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(InApplication.RESULT_CODE_ALL_MEMBER, intent);
                    finish();
                    break;
                case R.id.right_btn:
                    if (mIsDeleteMode) {
